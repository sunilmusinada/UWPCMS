#pragma checksum "F:\downloads\CMS\CMS-Survey\UWPCMS\CMS-Survey\Views\SettingsPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "D8B4148D2A5E1C58B630D82913B91C8C"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace CMS_Survey.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::CMS_Survey.Views.SettingsPage dataRoot;
            ...
            public void SetDataRoot(global::CMS_Survey.Views.SettingsPage newDataRoot)
            {
            ...
            private void Update_(global::CMS_Survey.Views.SettingsPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::CMS_Survey.ViewModels.SettingsPageViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel_SettingsPartViewModel(global::CMS_Survey.ViewModels.SettingsPartViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_SettingsPartViewModel_RefreshProviders(obj.RefreshProviders, phase);
                    }
                }
            }
            private void Update_ViewModel_SettingsPartViewModel_RefreshProviders(global::Template10.Mvvm.DelegateCommand obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 2:
                {
                    this.ViewModel = (global::CMS_Survey.ViewModels.SettingsPageViewModel)(target);
                }
                break;
            case 3:
                {
            ...
            case 15:
                {
                    ...
                    ((global::Windows.UI.Xaml.Controls.ComboBox)this.StateCombobox).SelectionChanged += this.StateSelectionChanged;
                    #line default
                }
                break;
            default:
